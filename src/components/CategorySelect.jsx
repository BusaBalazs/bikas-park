  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center px-5 pt-8 pb-12">
      ...
      <div className="relative flex flex-col items-center gap-6 max-w-sm w-full">
        ...
        <MascotBubble
          text={t.mascotCategoryPrompt}
          bubbleKey="category-prompt"
          action="wave"
          size={92}
        />
        ...
        <div className="flex flex-col gap-5 w-full">
          {categories.map((cat, i) => {
            const puzzlesInCat = PUZZLE_CATALOG.filter(
              (p) => p.category === cat.id,
            );
            ...
            return (
              ...
              >
                ...
                <div className=" relative rounded-[1.1rem] overflow-hidden aspect-[16/10] bg-park-bg2">
                  <img
                    src={cat.bg}
                    alt=""
                  ...
                  <div className="absolute z-10 top-0 flex w-full justify-between p-4 bg-gradient-to-t from-black/10 via-black/25 to-black/85">
